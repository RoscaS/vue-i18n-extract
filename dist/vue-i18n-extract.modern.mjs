...
async function createI18NReport(options) {
  ...
  const exclusionList = !Array.isArray(exclude) ? [exclude] : exclude;
  report.unusedKeys = report.unusedKeys.filter(key => !exclusionList.filter(excluded => key.path.startsWith(excluded)).length);
